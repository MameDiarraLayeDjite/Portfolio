                ...
                <form action="{{route('admin.footer-contact-info.update',1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="address" class="form-control" value="{{ $contact ? $contact->address: '' }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="phone" class="form-control" value="{{ $contact ? $contact->phone: '' }}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="email" class="form-control" value="{{ $contact ? $contact->email: '' }}">
                        </div>
                    </div>
