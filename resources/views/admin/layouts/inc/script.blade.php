...
//     console.log("Sidebar visibility: " + $('.main-sidebar').is(':visible'));
    
//     setTimeout(function() {
//         console.log("Sidebar visibility after 1 second: " + $('.main-sidebar').is(':visible'));
//     }, 1000);

//     // Vérifier toutes les 5 secondes pendant 1 minute
//     for (let i = 1; i <= 12; i++) {
//         setTimeout(function() {
//             console.log("Sidebar visibility after " + (i*5) + " seconds: " + $('.main-sidebar').is(':visible'));
//         }, i * 5000);
//     }
// });
</script>
