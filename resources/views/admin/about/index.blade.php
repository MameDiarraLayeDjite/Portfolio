            ...
            <div class="card-body">
                <form action="{{route('admin.about.update',1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <textarea name="description" class="summernote">{!! $about ? $about->description : '' !!}</textarea>
                        </div>
                    </div>
...
@push('scripts')
  <script>
    $(document).ready(function(){
        $('#image-preview').css({
            'background-image': 'url("{{ $about && $about->image ? asset($about->image) : asset('images/default-image.jpg') }}")',
