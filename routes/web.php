...
Route::get('politique-confidentialite', [HomeController::class, 'privacyPolicy'])->name('privacy');
Route::get('conditions-utilisation', [HomeController::class, 'termsOfService'])->name('terms');
Route::get('support-technique', [HomeController::class, 'technicalSupport'])->name('support');
Route::post('support-technique', [HomeController::class, 'submitSupport'])->name('support.submit');
